...
static int _write_internal(ringbuf_handle_t handle, const char *buf, int size, RingBufferAttr attr)
{
  RingBuf *ring_buf = (RingBuf *)handle;
  int pos, remain;
...
static int _ring_buffer_write(ringbuf_handle_t handle, const char *src, int writelen, RingBufferAttr attr)
{
...
int amf_ringbuf_write(ringbuf_handle_t handle, const char *src, int writelen)
{
